...
export default function ChangelogPage() {
  return <main className={styles.site} id="main-content" tabIndex={-1}>
    ...
    <section className={styles.pageSection}><div className={styles.emptyState}><History size={30} strokeWidth={1.3} /><h2>No formal releases yet.</h2><p>The interactive web demo is currently available. Version numbers, dates, improvements, and fixes will be added here only when releases are published.</p><Link className={styles.inlineLink} href="/atlas">Explore the web demo <ArrowRight size={14} /></Link></div></section>
    <SiteFooter />
  </main>;
}
